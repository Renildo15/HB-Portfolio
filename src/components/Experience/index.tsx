...
export default function Experience() {
    return(
        <section className={styles.section_experience} id="experience">
                ...
                <div className={styles.experiences}>
                    <div className={styles.experience_item}>
                        ...
                        <div className={styles.experience_item_content}>
                            <div className={styles.experience_item_header}>

                                {/* <Image
                                    src="https://pt.wikipedia.org/wiki/Ficheiro:Google_%22G%22_logo.svg"
                                    alt="Google Logo"
                                    width={32}
                                    height={32}
                                /> */}
                                ...
                                <span className={styles.experience_item_title}>Lead Software Engineer at Google</span>
                            </div>
                            <span className={styles.experience_item_date}>Nov 2019 - Present</span>
                        </div>
                        <span className={styles.experience_item_description}>
